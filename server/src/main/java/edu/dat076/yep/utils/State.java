...
public final class State {
     ...
     */
    public static void populateModel(ModelAndView model, HttpServletRequest request) {
        model.addObject("__requestPath", getRequestPath(request));
    }
